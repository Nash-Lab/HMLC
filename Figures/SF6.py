...
temp_shape = locals()[f'lcs_{s}'].shape[1]
for i in range(temp_shape):
    ax_A.plot(Ns_tr_norm,locals()[f'lcs_{s}'][level_of_accuracy,i,:],color = cmap_A(i/(1e-8+temp_shape-1)))
ax_A.plot(Ns_tr_norm,locals()[f'lcs_{s}'][0,0,:],color = 'k', linestyle = ':')
...
temp_shape = locals()[f'lcs_{s}'].shape[1]
for i in range(temp_shape):
    ax_B.plot(Ns_tr_norm,locals()[f'lcs_{s}'][level_of_accuracy,i,:],color = cmap_B(i/(1e-8+temp_shape-1)))
ax_B.plot(Ns_tr_norm,locals()[f'lcs_{s}'][0,0,:],color = 'k', linestyle = ':')
...
temp_shape = locals()[f'lcs_{s}'].shape[1]
for i in range(temp_shape):
    ax_C.plot(Ns_tr_norm,locals()[f'lcs_{s}'][level_of_accuracy,i,:],color = cmap_C(i/(1e-8+temp_shape-1)))
ax_C.plot(Ns_tr_norm,locals()[f'lcs_{s}'][0,0,:],color = 'k', linestyle = ':')
...
for i in range(temp_shape)[::-1]:
    ax_D.plot(Ns_tr_norm,locals()[f'lcs_{s}'][level_of_accuracy,i,:],color = cmap_D((temp_shape-i)/(1e-8+temp_shape-1)))
ax_D.plot(Ns_tr_norm,locals()[f'lcs_{s}'][0,0,:],color = 'k', linestyle = ':')
...
#%% Save
plt.savefig('SF6'+".svg",dpi = 300, format="svg",transparent=True)
plt.savefig('SF6'+'.png',dpi = 400, format='png')