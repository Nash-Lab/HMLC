...
#%% Parameters
data_path = '../Results/'
# data_name = '02_bias_vs_variance_error_3sigma.npy'
data_name = '02_bias_vs_variance_error_sqrt2_pi_sigma.npy'
...
#%% Load Data
data = np.load(data_path+data_name,allow_pickle=True).flatten()[0]
for k in data.keys():
    locals()[k] = data[k]
bias = data['bias']
var = data['var']
bias_plus_var = data['bias_plus_var']
Ns = data['Ns']
HSs = data['HSs']
...
caption_D_11 = plt.text(temp, 1-temp, r'$@N_{s}^{crit}$', horizontalalignment='left', fontsize=fontsize,
                     verticalalignment='top', transform=ax_D_11.transAxes)
caption_D_11.set_in_layout(False)


# caption_D_00_l = plt.text(temp, temp, r'D1', horizontalalignment='left', fontsize=fontsize,
#                      verticalalignment='bottom', transform=ax_D_00.transAxes)
# caption_D_00_l.set_in_layout(False)

# caption_D_01_l = plt.text(temp, temp, r'D2', horizontalalignment='left', fontsize=fontsize,
#                      verticalalignment='bottom', transform=ax_D_01.transAxes)
# caption_D_01_l.set_in_layout(False)

# caption_D_10_l = plt.text(temp, temp, r'D3', horizontalalignment='left', fontsize=fontsize,
#                      verticalalignment='bottom', transform=ax_D_10.transAxes)
# caption_D_10_l.set_in_layout(False)

# caption_D_11_l = plt.text(temp, temp, r'D4', horizontalalignment='left', fontsize=fontsize,
#                      verticalalignment='bottom', transform=ax_D_11.transAxes)
# caption_D_11_l.set_in_layout(False)
...
caption_A = plt.text(0.5, 0.5, r'$Bias$'+'\n'+r'$(B.)$', horizontalalignment='center', fontsize=fontsize_sup,
...
caption_B = plt.text(0.5, 0.5, r'$Var.$'+'\n'+r'$(V.)$', horizontalalignment='center', fontsize=fontsize_sup,
...
caption_C = plt.text(0.5, 0.5, r'$Bias$'+'\n'+'$+$'+'\n'+r'$Var.$', horizontalalignment='center', fontsize=fontsize_sup,
...
#%% Save
plt.savefig('F3'+".svg",dpi = 300, format="svg",transparent=True)
plt.savefig('F3'+'.png',dpi = 400, format='png')